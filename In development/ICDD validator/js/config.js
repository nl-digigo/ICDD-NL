...
function changeSOTD()
{
  ...
  // {
    ...
    {
      case "WV":
        tag.innerHTML +=  "This is de working draft version. '" + document.title + "'. "; 
        break;
      case "CV":
      ...
      case "DF":
        tag.innerHTML +=  "Dit is de definitieve versie van het document '" + document.title + "'. " + 
          ...
          break;
      case "BASIS":
        tag.innerHTML +=  "This is a document without official status.";
          break;
    }
...
var respecConfig = {
    ...
    github: "https://github.com/bimloket/ICDD",
